...
4. Сгенерируй ответ на том же языке, с учётом уже полученной информации (без повторных вопросов!)
5. Дай конкретную рекомендацию для менеджера по следующему действию
...
`;
    ...
    try {
      ...
      parsed = {
        reply: content,
        error: "⚠️ Ответ не в формате JSON"
      };
    }
